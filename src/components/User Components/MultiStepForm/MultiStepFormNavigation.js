...
const MultiStepFormNavigation = ({ currentStep, totalSteps, onStepChange }) => {
  ...
  const sectionLabels = {
    ...
    7: "Education Section",
    8: "Domestic Section",
    9: "Domestic Impact Section",
    10: "Medical History Section",
    11: "General Observation Section",
    12: "Physical Examination Section",
    13: "Diagnosis Section",
    14: "Opinion Section",
    15: "Prognosis Section",
    16: "Prognosis Detailed Section",
    17: "Statement Of Truth Section",
    18: "Expert Bibliography Section"
  };
