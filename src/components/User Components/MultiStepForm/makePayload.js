    ...
    switch (step) {
      case 0:
        return {
          ...
          claimantDetails: {
            ...
            dateOfBirth:
              formData.dateOfBirth || defaultData.claimantDetails.dateOfBirth,
            address: formData.address || defaultData.claimantDetails.address,
            occupation:
              formData.occupation || defaultData.claimantDetails.occupation,
            typeOfIdChecked:
              formData.whichTypeOfIDChecked ||
              defaultData.claimantDetails.typeOfIdChecked,
            dateOfExamination:
              formData.dateOfExamination ||
              defaultData.claimantDetails.dateOfExamination,
            recordsWereSeen:
              formData.whichRecordsSeen ||
              defaultData.claimantDetails.recordsWereSeen,
            dateOfAccident:
              formData.dateOfAccident ||
              defaultData.claimantDetails.dateOfAccident,
            ageAtTimeOfAccident:
              formData.ageAtTimeOfAccident ||
              defaultData.claimantDetails.ageAtTimeOfAccident,
            medicalReportsProvided:
              formData.medicalRecordsProvided ||
              defaultData.claimantDetails.medicalReportsProvided,
            photoIdConfirmed:
              formData.hasPhotoIDConfirmed ||
              defaultData.claimantDetails.photoIdConfirmed,
            accompaniedBy:
              formData.accompaniedBy ||
              defaultData.claimantDetails.accompaniedBy,
            placeOfExamination:
              formData.placeOfExamination ||
              defaultData.claimantDetails.placeOfExamination,
            durationOfExamination:
              formData.durationOfExamination ||
              defaultData.claimantDetails.durationOfExamination,
            dateOfReport:
              formData.dateOfReport || defaultData.claimantDetails.dateOfReport,
            instructingParty:
              formData.instructingParty ||
              defaultData.claimantDetails.instructingParty,
            instructingPartyRef:
              formData.instructingPartyRef ||
              defaultData.claimantDetails.instructingPartyRef,
            agency: formData.agency || defaultData.claimantDetails.agency,
            agencyRef:
              formData.agencyRef || defaultData.claimantDetails.agencyRef,
            medcoCaseNumber:
              formData.medcoCaseNumber ||
              defaultData.claimantDetails.medcoCaseNumber,
          },
        };
      case 1:
        return {
          ...
          accidentDetails: {
            vehicleType:
              formData.vehicleType || defaultData.accidentDetails.vehicleType,
            otherVehicleType:
              formData.otherVehicleType ||
              defaultData.accidentDetails.otherVehicleType,
            vehicleWheels:
              formData.vehicleWheels ||
              defaultData.accidentDetails.vehicleWheels,
          },
        };
      case 2:
        return {
          ...
          accidentSection: {
            timeOfAccident:
              ...
              defaultData.accidentSection.timeOfAccident,
            speedOfImpact:
              formData.impactSpeed || defaultData.accidentSection.speedOfImpact,
            accidentLocation:
              formData.accidentLocation ||
              defaultData.accidentSection.accidentLocation,
            levelOfDamageVehicle:
              formData.vehicleDamage ||
              defaultData.accidentSection.levelOfDamageVehicle,
      ...
      case 3:
        return {
          ...
          anatomySection: {
            anatomySelectedOptions:
              formData.anatomy ||
              defaultData.anatomySection.anatomySelectedOptions,
            psychologicalInjuriesSelectedOptions:
              formData.psychologicalInjuries ||
              defaultData.anatomySection.psychologicalInjuriesSelectedOptions,
          },
        };
      case 4:
        ...
        return {
          ...
          symptomsSection: {
            questions: (symptoms || defaultData.symptomsSection.questions).map(
              (symptom) => ({
                type:
                  symptom.type || defaultData.symptomsSection.questions[0].type,
                symptomsStart:
                  symptom.startTime ||
                  defaultData.symptomsSection.questions[0].symptomsStart,
                severityNow:
                  symptom.currentSeverity ||
                  defaultData.symptomsSection.questions[0].severityNow,
                severityOnset:
                  symptom.severityOnset ||
                  defaultData.symptomsSection.questions[0].severityOnset,
                symptomsResolvedDuration:
                  symptom.resolvedDuration ||
                  defaultData.symptomsSection.questions[0]
                    .symptomsResolvedDuration,
        ...
        return {
          ...
          treatmentSection: {
            immediateTreatment: {
              ...
              otherServiceAttendedSceneOfAccident:
                formData.otherServiceAtAccident,
              otherLocationWentAfterAccident:
                formData.otherPostLocationAccident,
              otherTreatmentReceivedAtSceneOfAccident:
                formData.otherTreatmentAtAccident,
            ...
            laterTreatment: {
              ...
              durationOfTreatmentReceivedAfterAccident:
                formData.treatmentTimeAfterAccident,
        ...
        return {
          ...
          employmentEducationSection: {
            ...
            durationTakenOffFromSchoolAfterAccident:
              formData.durationTakenOffFromSchoolAfterAccident,
            hoursGaveToEducation: formData.hoursEmployment,
            phasedReturnToSchoolManagement:
              formData.phasedReturnToSchoolManagement,
          },
        };
      case 8:
        return {
      ...
      case 9:
        const domesticImpactQuestions = groupRelatedQuestions(
          formData,
          "domesticImpact"
        );
      ...
      case 12:
        const physicalExaminationQuestions = groupRelatedQuestions(
          formData,
          "physicalExamination"
        );
        return {
      ...
      case 13:
        const physicalInjuriesDiagnosisQuestions = groupRelatedQuestions(
          formData,
          "physicalInjuriesDiagnosis"
        );
        const psychologicalInjuriesDiagnosisQuestions = groupRelatedQuestions(
          formData,
          "psychologicalInjuriesDiagnosis"
        );
        ...
        return {
          ...
          diagnosisSection: {
            ...
            psychologicalInjuries: {
              questions: psychologicalInjuriesDiagnosisQuestions.map(
                (injury) => ({
                  type: injury.type,
                  mechanismOfInjury: injury.injuryMechanism,
                  otherMechanismOfInjury: injury.otherInjuryMechanism,
      ...
      case 14:
        const physicalInjuriesOpinionQuestions = groupRelatedQuestions(
          formData,
          "physicalInjuriesOpinion"
        );
        const psychologicalInjuriesOpinionQuestions = groupRelatedQuestions(
          formData,
          "psychologicalInjuriesOpinion"
        );
        ...
        return {
          ...
          opinionSection: {
            ...
            psychologicalInjuries: {
              questions: psychologicalInjuriesOpinionQuestions?.map(
                (opinion) => ({
                  type: toCamelCase(opinion.type),
                  opinion: opinion.injuryOpinion,
                })
            ...
            exceptionalCircumstances: {
              claimantClaimedAnyExceptionalCircumstance:
                formData.claimedExceptionalCircumstances,
              anyExceptionalCircumstanceInAccident:
                formData.exceptionalCircumstancesInAccident,
              ...
              injuriesResultOfExceptionalCircumstance:
                formData.injuriesResultOfExceptionalCircumstances,
              anythingElse: formData.anythingElse,
            },
          },
        };
      case 15:
        const prognosisPhysicalInjuries = groupRelatedQuestions(
          formData,
          "physicalInjuriesPrognosis"
        );
        const prognosisPsychologicalInjuries = groupRelatedQuestions(
          formData,
          "psychologicalInjuriesPrognosis"
        );
      ...
      case 16:
        const detailedPrognosisPhysicalInjuries = groupRelatedQuestions(
          formData,
          "physicalInjuriesDetailedPrognosis"
        );
        const detailedPrognosisPsychologicalInjuries = groupRelatedQuestions(
          formData,
          "psychologicalInjuriesDetailedPrognosis"
        );
          ...
          prognosisDetailedSection: {
            physicalInjuries: {
              questions: detailedPrognosisPhysicalInjuries.map((prognosis) => ({
                ...
                fromDateAccident: prognosis.fromDateAccident,
              })),
            },
            psychologicalInjuries: {
              questions: detailedPrognosisPsychologicalInjuries.map(
                (prognosis) => ({
                  type: prognosis.type,
                  whenDidItResolved: prognosis.whenDidItResolved,
                  timeWillTakeToRecover: prognosis.timeWillTakeToRecover,
                  claimantRequireSpecialist:
                    prognosis.claimantRequireSpecialist,
                  otherRecommendation: prognosis.otherRecommendation,
                  severeDisability: prognosis.severeDisability,
                  specialist: prognosis.specialist,
                  otherSpecialist: prognosis.otherSpecialist,
                  ...
                  treatmentAndRehabiliation:
                    prognosis.treatmentAndRehabiliation,
                  fromDateAccident: prognosis.fromDateAccident,
                })
              ),
            },
      ...
      case 18:
        return {
          ...
          expertBibliographySection: {
            selectedBibliography: formData.selectedBibliographies?.map(
...
const defaultData = {
  ...
  symptomsSection: {
    questions: [
      {
        type: "Pain",
        symptomsStart: "2024-01-01",
        severityNow: "Moderate",
        severityOnset: "Severe",
        symptomsResolvedDuration: "2 weeks",
      },
    ],
  },
  treatmentSection: {
  ...
  medicalHistorySection: {
    ...
    medicalNotesReviewed: [
      { fileName: "Report1.pdf", expertReview: "Reviewed" },
    ],
  },
  generalObservationSection: {
  ...
  physicalExaminationSection: {
    questions: [
      {
        type: "Observation",
        observationOfPalpation: "Normal",
        observationOnFlexios: "Normal",
      },
    ],
  },
  diagnosisSection: {
      ...
      questions: [
        {
          ...
          status: "Resolved",
          resolvedQuestions: {
            whenDidItResolved: "2024-02-15",
            anyLogTermSequelae: "No",
            fromDateAccident: "From Date of Examination",
          },
          ongoingQuestions: {
            timeWillTakeToRecover: "6 weeks",
            claimantRequireSpecialist: "No",
            otherRecommendation: "Rest",
            severeDisability: "No",
            specialist: "N/A",
            anyLogTermSequelae: "No",
            treatmentAndRehabilitation: "Physical Therapy",
          },
        },
      ],
    },
      ...
      questions: [
        {
          ...
          status: "Ongoing",
          resolvedQuestions: {
            whenDidItResolved: "N/A",
            anyLogTermSequelae: "Possible",
            fromDateAccident: "From Date of Examination",
          },
          ongoingQuestions: {
            timeWillTakeToRecover: "Ongoing",
            recommendCheckupSpecialist: "yes",
            otherRecommendation: "Counseling",
            severeDisability: "No",
